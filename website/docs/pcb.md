...
| :---------------------------------: | :---------------------------------------: |
| ![PCBA Top](/img/renders/pcba-iso-front.png) | ![PCBA Bottom](/img/renders/pcba-bottom.png) |

|          Isometric Front            |            Isometric Back                |
| :---------------------------------: | :---------------------------------------: |
| ![PCBA Iso Front](/img/renders/pcba-iso-bottom-front.png) | ![PCBA Iso Back](/img/renders/pcba-iso-back.png) |

|          ESP32 Detail               |            Bottom Isometric              |
| :---------------------------------: | :---------------------------------------: |
| ![ESP32 Detail](/img/renders/pcba-detail-esp32.png) | ![PCBA Iso Bottom](/img/renders/pcba-iso-bottom-back.png) |
...
| C3-C16,C20,C21 | 100nF 0805             | C49678   | Basic    | 16  |
| C22        | 0.47µF 0805 (PAM8403)     | C1571    | Basic    | 1   |
| C23-C25    | 1µF 0805 (PAM8403)        | C15849   | Basic    | 3   |
...
- PCB: 241 trace segments, 202 vias, 45 nets, 72 footprints
