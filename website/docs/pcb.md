...
| :---------------------------------: | :---------------------------------------: |
| ![PCBA Iso Front](/img/renders/pcba/pcba-iso-bottom-front.png) | ![PCBA Iso Back](/img/renders/pcba/pcba-iso-back.png) |

|          ESP32 Detail               |            Bottom Isometric              |
| :---------------------------------: | :---------------------------------------: |
| ![ESP32 Detail](/img/renders/pcba/pcba-detail-esp32.png) | ![PCBA Iso Bottom](/img/renders/pcba/pcba-iso-bottom-back.png) |
...
| J3         | JST PH 2-pin SMD (battery) | C265082  | Extended | 1   |
...
- PCB: 483 trace segments, 290 vias, 52 nets, 85 footprints
