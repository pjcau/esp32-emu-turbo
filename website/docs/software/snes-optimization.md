...
| 3.3V buck (shared) | — | — | $0.00 | Uses existing SY8089A |
| **Total v2 addition** | | | **$3.27** | |

**v2 total BOM delta:** ~$3.27. The ESP32-S3-MINI-1 runs at 3.3V from the existing SY8089A buck regulator (which has 2 A headroom — the MINI-1 adds ~50 mA for single-core audio tasks, well within budget).
