...
- **U3 SY8089AAAC** (SOT-23-5) — 3.3V buck, below center
...
| U3         | SY8089AAAC buck            | C78988   | Basic    | 1   |
...
| 1     | `01-power-supply.kicad_sch` | USB-C, IP5306, SY8089A buck, battery, LEDs, power switch |
...
The +5V island on In2.Cu covers the IP5306/SY8089A/L1 area. Priority 1 ensures +5V wins in the overlap region. Components outside this area connect to +3V3 via the base zone.
...
- SY8089A thermal: a switching buck at ~90% efficiency dissipates ~0.1W here, well under the 0.57W the AMS1117 LDO burned at the same load
