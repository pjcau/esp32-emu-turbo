...
| U3         | SY8089AAAC 2A buck         | C78988   | Basic    | 1   |
...
| J3         | JST PH 2-pin SMD (battery) | C295747  | Extended | 1   |
| L1         | 1µH inductor 4.5A          | C280579  | Extended | 1   |
| LED1       | Red LED 0805 (charging)    | C84256   | Basic    | 1   |
| LED2       | Green LED 0805 (full)      | C19171391 | Basic    | 1   |
| R1-R2      | 5.1k 0805                  | C27834   | Basic    | 2   |
| R4-R13,R15 | 10k 0805                    | C17414   | Basic    | 11  |
| R16        | 100k 0805                  | C149504  | Basic    | 1   |
| R17-R18    | 1k 0805 (LED)              | C17513   | Basic    | 2   |
| R20-R21    | 20k 0805 (PAM8403)         | C4328    | Basic    | 2   |
| C3-C16,C21,C26 | 100nF 0805              | C49678   | Basic    | 16  |
| C22        | 0.47µF 0805 (PAM8403)     | C13967   | Basic    | 1   |
| C23-C25    | 1µF 0805 (PAM8403)        | C28323   | Basic    | 3   |
| C1,C17,C18,C27 | 10µF 0805               | C15850   | Basic    | 4   |
| C2         | 22µF 16V 1206 tantalum (Vishay TMCMA1C226MTRF) | C1953590 | Extended | 1   |
| C19        | 22µF 1206                  | C12891   | Basic    | 1   |
| SW1-SW13,SW15,SW14 | SMT tact switch | C318884  | Extended | 15  |
| SW16     | Slide switch SS-12D00G3    | C431540  | Extended | 1   |
...
2. **BOM.csv** — `release_jlcpcb/bom.csv` (28 part-number groups, 77 placements)
...
| 1     | `01-power-supply.kicad_sch` | USB-C, IP5306, SY8089 buck, battery, LEDs, power switch |
...
All automated checks passed before JLCPCB production order (v2.1):
...
**GPIO Mapping:**
- 33/45 GPIOs used, no conflicts with PSRAM (GPIO 26-32)
...
| C26,C27 | 100nF 0805         | B.Cu (bottom) | Adjacent to U7           | Decoupling             |
