...
# Injects every known fault class (historical + predicted: split plane, CPL rotation,
...
make verify-gate-coverage  # MUST catch ALL faults, each by its OWNER (expect field)
