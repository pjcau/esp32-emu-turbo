...
COMPONENT_SPECS = {
    ...
    "U2": {
        ...
        "pins": {
            ...
            "3":  {"net": _any_of("", "GND"),     "function": "LED2 — unused, GND trace overlap accepted", "type": "smd"},
            "4":  {"net": _any_of("", "GND"),     "function": "LED3 — unused, GND trace overlap accepted", "type": "smd"},
    ...
    "U6": {
        ...
        "pins": {
            ...
            "8":  {"net": _any_of("", "SD_MISO"),  "function": "DAT1 — unused in SPI, SD_MISO trace overlap", "type": "smd"},
            "9":  {"net": _any_of("", "BTN_R"),   "function": "CD — unused, BTN_R trace overlap accepted", "type": "smd"},
    ...
    "J4": {
        ...
        "pins": {
            ...
            "37": {"net": _any_of("", "GND"),  "function": "NC — GND trace overlap accepted", "type": "smd"},
    ...
    "SW_PWR": {
        ...
        "pins": {
            ...
            "4b": {"net": _any_of("", "BTN_SELECT"),  "function": "Shell — BTN_SELECT trace overlap accepted", "type": "smd"},
            "4c": {"net": _unconnected(),  "function": "Shell/anchor (mechanical)", "type": "smd"},
            "4d": {"net": _any_of("", "BTN_SELECT"),  "function": "Shell — BTN_SELECT trace overlap accepted", "type": "smd"},
        },
    },
