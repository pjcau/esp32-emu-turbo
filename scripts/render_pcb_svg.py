...
COMPONENTS_BOTTOM = [
    ...
    ("U3", "SY8089", "SOT-23-5", 119.8, 53.5, 3.7, 2.5),
    ("U5", "PAM8403", "SOP-16", 30.0, 29.5, 10, 6),
    ("L1", "1uH", "Inductor", 110.0, 52.5, 4, 4),
    ("L2", "2.2uH", "Inductor", 126.0, 54.45, 5.1, 4),
    ("J3", "Battery", "JST-PH", 80.0, 57.5, 6, 4.5),
]
...
PASSIVES_BACK = [
    ("R1", "5.1k", 74.0, 67.0), ("R2", "5.1k", 86.0, 67.0),
    ("R3", "10k", 65.0, 42.0), ("C3", "100n", 70.0, 42.0),
    ("C4", "100n", 85.0, 42.0),
    ("R17", "1k", 75.0, 42.0), ("R18", "1k", 80.0, 42.0),
    # Button pull-up resistors — row below ESP32 (y=46, x=43..103)
    ("R4", "10k", 43.0, 46.0), ("R5", "10k", 48.0, 46.0),
    ("R6", "10k", 53.0, 46.0), ("R7", "10k", 58.0, 46.0),
    ("R8", "10k", 63.0, 46.0), ("R9", "10k", 68.0, 46.0),
    ("R10", "10k", 73.0, 46.0), ("R11", "10k", 78.0, 46.0),
    ("R12", "10k", 83.0, 46.0), ("R13", "10k", 88.0, 46.0),
    ("R14", "10k", 93.0, 46.0), ("R15", "10k", 98.0, 46.0),
    ("R19", "10k", 103.0, 46.0),
    # KEY pull-down (near IP5306)
    ("R16", "100k", 115.0, 52.5),
    # Button debounce caps — row below pull-ups (y=50, x=43..103)
    ("C5", "100n", 43.0, 50.0), ("C6", "100n", 48.0, 50.0),
    ("C7", "100n", 53.0, 50.0), ("C8", "100n", 58.0, 50.0),
    ("C9", "100n", 63.0, 50.0), ("C10", "100n", 68.0, 50.0),
    ("C11", "100n", 73.0, 50.0), ("C12", "100n", 78.0, 50.0),
    ("C13", "100n", 83.0, 50.0), ("C14", "100n", 88.0, 50.0),
    ("C15", "100n", 93.0, 50.0), ("C16", "100n", 98.0, 50.0),
    ("C20", "100n", 103.0, 50.0),
    # IP5306 caps
    ("C17", "10u", 110.0, 35.0), ("C18", "10u", 116.0, 37.5),
    ("C19", "22u", 110.0, 58.5),
    # SY8089 buck passives (C2 tantalum deleted)
    ("C1", "22u", 119.8, 56.6), ("C30", "22u", 127.8, 58.9),
    ("R25", "100k", 118.0, 63.4), ("R26", "22k", 121.1, 63.4),
    ("C29", "22p", 118.0, 60.3),
]
